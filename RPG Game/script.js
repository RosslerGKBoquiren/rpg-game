...
function update(location) {
  ...
  const locationImages = {
    "town square": "./images/town.jpg", 
    "store": "./images/store.jpg", 
    "cave": "./images/cave.jpg" 
  };

  if (locationImages[location.name]) {
    locationImage.src = locationImages[location.name];
...
function goFight() {
  ...
  const monsterImages = {
    "slime": "./images/slime.jpg", 
    "beast": "./images/beast.jpeg", 
    "dragon": "./images/dragon.jpg" 
  };
  monsterImage.src = monsterImages[monsters[fighting].name];
...
function adjustImageSize() {
  const locationImage = document.querySelector("#locationImage");
  if (locationImage) {
    locationImage.style.maxHeight = `${window.innerHeight * 0.4}px`; 
  }
}

// Adjust image size on page load and window resize
